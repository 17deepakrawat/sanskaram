        ...
        <div class="card card-transparent">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-md-2 m-b-10">
                <button class="btn btn-success" aria-label="" title="Download Wallet Payment" data-toggle="tooltip"
                  data-original-title="Download Wallet Payment" onclick="exportData('Wallet-Payment')"> <i
                    class="uil uil-down-arrow"></i> Download</button>
              </div>
            </div>
