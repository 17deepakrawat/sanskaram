...
?>
  ...
  <form role="form" id="form-allot-universities" action="/app/operations/allot" method="POST" enctype="multipart/form-data">
    <div class="modal-body">
      <?php 
          $universities = $conn->query("SELECT ID, CONCAT(Universities.Short_Name, ' (', Universities.Vertical, ')') as Name FROM Universities WHERE Status = 1 AND ID IN (SELECT University_User.University_ID FROM University_User)");
