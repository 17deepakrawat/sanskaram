    ...
    <div class="card-body">
      ...
      <div class="row p-b-20">
        <div class="col-lg-12 text-end">
          <button type="button" class="btn custom_add_button" onclick="addComponents('admission-sessions', 'md', <?= $university_id ?>)">Add <i class="uil uil-plus-circle ml-2"></i></button>
        </div>
      </div>
      ...
      },
      {
        ...
        "render": function(data, type, row) {
          return '<div class="text-end">\
            <i class="uil uil-edit icon-xs cursor-pointer custom_edit_button" onclick="editComponents(\'admission-sessions\', \'' + data + '\', \'md\');"></i>\
            <i class="uil uil-trash icon-xs cursor-pointer custom_edit_button" onclick="destroyComponents(\'admission-sessions\', \'AdmissionSessions\', \'' + data + '\');"></i>\
          </div>'
        }
      },
    ],
