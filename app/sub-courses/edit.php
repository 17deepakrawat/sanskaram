...
if (isset($_GET['id'])) {
  ...
  <form role="form" id="form-edit-sub-course" action="/app/sub-courses/update" method="POST"
    ...
    <div class="modal-body">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            <label>Name</label>
            <input type="text" name="name" class="form-control" placeholder="ex: Mechanical Engineering"
              value="<?= $sub_course['Name'] ?>" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            <label>Short Name</label>
            <input type="text" name="short_name" class="form-control" placeholder="ex: ME"
              value="<?= $sub_course['Short_Name'] ?>" required>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            ...
            <input type="text" name="in_house_course_name" class="form-control" placeholder="ex: Mechanical Engineering"
              value="<?= $sub_course['in_house_course_name'] ?>" required>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            ...
            ?>
            <input type="tel" name="min_duration" id="min_duration" class="form-control" onchange="getFeeSructures()"
              value="<?= $min_due ?>" required>
          </div>
          <!--  <label>Min Duration</label>-->
        ...
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            ...
            <input type="tel" name="max_duration" class="form-control" placeholder="ex: 8"
              onkeypress="return isNumberKey(event)" value="<?= $sub_course['SOL'] ?>" required>
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group form-group-default">
            ...
            <input type="text" id="le_start" name="le_start" class="form-control" placeholder="ex: 3,5"
              value="<?php print $sub_course['LE_Start'] == '' ? '' : $sub_course['LE_Start'] ?>">
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="form-group form-group-default">
            <label>LE SOL</label>
            <input type="tel" id="le_sol" name="le_sol" class="form-control" placeholder="ex: 8"
              onkeypress="return isNumberKey(event)"
              value="<?php print $sub_course['LE_SOL'] == 0 ? '' : $sub_course['LE_SOL'] ?>">
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group form-group-default">
            ...
            <input type="tel" id="ct_start" name="ct_start" class="form-control" placeholder="ex: 3"
              onkeypress="return isNumberKey(event)"
              value="<?php print $sub_course['CT_Start'] == 0 ? '' : $sub_course['CT_Start'] ?>">
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="form-group form-group-default">
            <label>CT SOL</label>
            <input type="tel" id="ct_sol" name="ct_sol" class="form-control" placeholder="ex: 8"
              onkeypress="return isNumberKey(event)"
              value="<?php print $sub_course['CT_SOL'] == 0 ? '' : $sub_course['CT_SOL'] ?>">
          </div>
        </div>
      </div>
