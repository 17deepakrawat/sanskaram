...
error_reporting(E_ALL);
 ...
 // echo '<pre>';print_r($sub_course);die;
?>
...
<form role="form" id="form-edit-sub-course" action="/app/sub-courses/update" method="POST" enctype="multipart/form-data">
  ...
  <?php if($_SESSION['university_id'] == 48){ ?>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group form-group-default required">
          ...
          <input type="text" name="in_house_course_name" class="form-control" placeholder="ex: ME" value="<?= $sub_course['in_house_course_name'] ?>" required>
        </div>
      </div>
    </div>
    ...
    <?php
     $course_category = array("certification","certified","advance_diploma","pg_diploma");
     $selected_course_category = !empty($sub_course['Course_Category']) ? json_decode($sub_course['Course_Category'], true) : [];
    // print_r($selected_course_category);die;
     $durations = array("3","6","11/certified","11/advance-diploma","11/pg-diploma");
  ...
  <?php } else { ?>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group form-group-default required">
          <label>Name (In-House)</label>
          <input type="text" name="in_house_course_name" class="form-control" placeholder="ex: Mechanical Engineering" value="<?= $sub_course['in_house_course_name'] ?>" required>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            ...
            if($_SESSION['university_id']=='47'){
              $min_due = json_decode($sub_course['Min_Duration'],true);
            }else{
               $min_due = $sub_course['Min_Duration'];
            }
            ?>
            <input type="tel" name="min_duration" id="min_duration" class="form-control" onchange="getFeeSructures()" value="<?=  $min_due ?>" required>
          </div>
          <!--  <label>Min Duration</label>-->
...
<script>
  ...
  $("#form-edit-sub-course").on("submit", function(e) {
   ...
   function chooseDuration(selectElement) {
    ...
    var conditions = [
        { values: ['certification', 'certified', 'advance_diploma','pg_diploma'], content: '<option value="3">3 Months</option><option value="6">6 Months</option><option value="11/certified">11 Months Certified</option><option value="11/advance-diploma">11 Months Advance Diploma</option><option value="11/pg-diploma">11 Months PG Diploma</option>' },
        ...
        { values: ['certification', 'pg_diploma'], content: '<option value="3">3 Months</option><option value="11/advance-diploma">11 Months Advance Diploma</option><option value="11/pg-diploma">11 Months PG Diploma</option>' },
        ...
        { values: ['certified', 'pg_diploma'], content: '<option value="6">6 Months</option><option value="11/certified">11 Months Certified</option><option value="11/pg-diploma">11 Months PG Diploma</option>' },
        ...
        { values: ['pg_diploma'], content: '<option value="11/pg-diploma" selected>11 Months PG Diploma' },
    ];
