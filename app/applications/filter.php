...
if (isset($_POST['id']) && isset($_POST['by'])) {
  ...
  if ($by == 'departments') {
  ...
  }elseif ($by == 'exam_exit_status') {
    $enrolledQuery ="";
    if($id == 5){
      $enrolledQuery = " OR Students.Enrollment_No IS NOT NULL";
    }
    $_SESSION['filterByExamStatus'] = " AND Students.exam_exit_status = $id".$enrolledQuery;
    ...
    $_SESSION['filterByDuration'] = " AND Students.Duration = '".$id."'";
  }
  // echo "<pre>";
  // print_r($_SESSION);
