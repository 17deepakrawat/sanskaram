...
if (isset($_POST['inserted_id'])) {
  ...
  $high_marksheet_reference_no = mysqli_real_escape_string($conn, $_POST['high_marksheet_reference_no']);
  ...
  $inter_marksheet_reference_no = mysqli_real_escape_string($conn, $_POST['inter_marksheet_reference_no']);
  ...
  $ug_marksheet_reference_no = mysqli_real_escape_string($conn, $_POST['ug_marksheet_reference_no']);
  ...
  $pg_marksheet_reference_no = mysqli_real_escape_string($conn, $_POST['pg_marksheet_reference_no']);
  ...
  $other_marksheet_reference_no = mysqli_real_escape_string($conn, $_POST['other_marksheet_reference_no']);
