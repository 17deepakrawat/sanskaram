...
Sub_Courses ON student_assignment.sub_course_id = Sub_Courses.ID
LEFT JOIN 
Syllabi ON student_assignment.subject_id = Syllabi.ID LEFT JOIN
 Admission_Sessions ON student_assignment.adm_session = Admission_Sessions.ID where student_assignment.Assignment_id $searchQuery $uniQuery  $session_query  $filterByprogram  $query");
