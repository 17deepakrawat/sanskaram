        ...
        <div class=" container-fluid   sm-p-l-0 sm-p-r-0">
          <div class="inner">
            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              ?>
              <div class="text-end">
                <span class="text-muted bold cursor-pointer custom_add_button text-white" onclick="add('universities','lg')"> Add <i class="uil uil-plus-circle ml-2"></i></sapn>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
        ...
        <div class="card card-transparent">
          <div class="card-header">
            <div class="pull-right">
              <div class="col-xs-12">
                <input type="text" id="universities-search-table" class="form-control pull-right custom_search_section" placeholder="Search">
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="">
              <table class="table table-hover nowrap table-responsive" id="universities-table">
                <thead>
                  <tr>
          ...
          'columns': [{
            ...
            },
            {
              ...
              "render": function(data, type, row) {
                ...
                <i class="uil uil-edit icon-xs cursor-pointer custom_edit_button" onclick="edit(&#39;universities&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="uil uil-trash icon-xs cursor-pointer custom_delete_button" onclick="destroy(&#39;universities&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
              }
            },
          ],
