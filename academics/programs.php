            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <div>
                <?php if (in_array($_SESSION['Role'], ['Administrator', 'University Head'])) { ?>
                  ...
                  <button class=" custom_add_button " aria-label="" title="" data-toggle="tooltip" data-original-title="Add Program" onclick="add('courses','md')">Add <i class="uil uil-plus-circle ml-2"></i></button>
                <?php } ?>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
        ...
        var settings = {
          ...
          'columns': [{
            ...
            },
            {
              ...
              <span class="' + statusClass + ' ml-2" id="status-text-' + row.ID + '">' + statusText + '</span>\
            </div>';
              }
            },
            {
              ...
              "render": function(data, type, row) {
                ...
                <i class="uil uil-edit icon-xs cursor-pointer custom_edit_button" onclick="edit(&#39;courses&#39;, &#39;' + data + '&#39, &#39;md&#39;)"></i>\
                <i class="uil uil-trash icon-xs cursor-pointer custom_delete_button" onclick="destroy(&#39;courses&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
              },
