...
if ($student->num_rows > 0) {
    ...
    while ($getDataArr = $getDataSQL->fetch_assoc()) {
        ...
        $getDataArr['obt_marks_ext'] = ($getDataArr['obt_marks_ext'] == 'AB') ? 'AB' : $getDataArr['obt_marks_ext'];
        $getDataArr['obt_marks_int'] = ($getDataArr['obt_marks_int'] == 'AB') ? 'AB' : $getDataArr['obt_marks_int'];

        // start total obt
        $obt_marks_ab_ext = $getDataArr['obt_marks_ext'];
        $obt_marks_ab_int = $getDataArr['obt_marks_int'];

        if ($getDataArr['obt_marks_ext'] == 'AB') {
            $obt_marks_ab_ext = 0;
        } else if ($getDataArr['obt_marks_int'] == 'AB') {
            $obt_marks_ab_int = 0;
        }
        $getDataArr['total_obtain_ext_int'] = $obt_marks_ab_int + $obt_marks_ab_ext;
        // end  total obt
