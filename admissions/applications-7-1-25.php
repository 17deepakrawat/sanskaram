          ...
          var applicationSettings = {
            ...
            'columns': [{
                ...
                "render": function(data, type, row) {
                  ...
                  var deleted = showInhouse && row.Process_By_Center == 1 ? '<i class="uil uil-trash mr-1 cursor-pointer" title="Delete Application Form" style="'+edit_show_hide+'" onclick="destroy(&#39;application-form&#39;, &#39;' + data + '&#39;)"></i>' : '';
