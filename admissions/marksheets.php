            ...
            <form role="form" id="form-add-e-book" action="/app/marksheets/download-bulk-marksheets" method="POST"
              ...
              <div class="modal-footer clearfix justify-content-center">
                <div class="col-md-4 m-t-10 sm-m-t-10">
                  ...
                  <input type="submit" class="btn btn-primary btn-cons btn-animated from-left" name="marksheet_in_grade"
                    value="Marksheet In Grade">
                  <input type="submit" class="btn btn-primary btn-cons btn-animated from-left"
