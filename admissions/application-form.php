  ...
  <div class="page-content-wrapper ">
      ...
      <div class=" container-fluid  ">
        <div id="rootwizard" class="m-t-50">
          ...
          <div class="tab-content">
                        ...
                        <div class="col-md-4">
                          <div class="form-group form-group-default required">
                            ...
                            <select class="full-width" style="border: transparent;" data-init-plugin="select2"
                              name="center" id="center" onchange="getAdmissionSession(); getCourse()">
                    ...
                    <div class="padding-10 sm-padding-5">
                      ...
                      <div class="row clearfix">
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            <label>Mobile</label>
                            <input type="tel" name="contact" onkeypress="return isNumberKey(event);" minlength="10"
                              maxlength="10"
              ...
              <form id="step_3" role="form" autocomplete="off" action="/app/application-form/step-3" method="POST"
                ...
                <div class="row row-same-height">
                  <div class="col-md-4 b-r b-dashed b-grey sm-b-b">
                    ...
                    <h4>Note</h4>
                    <ol>
                      <li>Upload clear copies of 10th, 12th, and Degree certificates (or equivalents).</li>
                      <li>Verify that details match exactly with SSLC/Plus Two/Degree certificates.</li>
                    </ol>
                    ...
                    <div class="padding-10 sm-padding-5">
                      ...
                      <div class="row clearfix">
                        <div class="col-md-12">
                          ...
                          <ul>
                            <li>Adhere to passport-size specifications (white background).</li>
                            <li>No other photo formats will be accepted.</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="padding-10 sm-padding-5">
                      ...
                      <div class="row clearfix">
                        <div class="col-md-12">
                          ...
                          <ul>
                            <li> Ensure date of birth is included; otherwise, provide additional proof.</li>
                            <li>Upload a clear picture.</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="padding-10 sm-padding-5">
                      ...
                      <div class="row clearfix">
                        <div class="col-md-12">
                          ...
                          <ul>
                            <li> Provide a signature on plain white paper (not digital).</li>
                          </ul>
                        </div>
                      </div>
                    </div>
            ...
            <div class="tab-pane slide-left padding-20 sm-no-padding green_last_step" id="tab5">
    ...
    <script type="text/javascript">
      ...
      function highDetailsRequired() {
        ...
        $('#high_marksheet_reference_no').validate();
        $('#high_marksheet_reference_no').rules('add', {
          required: true
        });
        <?php if (empty($id)) { ?>
      ...
      function highDetailsNotRequired() {
        ...
        $('#high_marksheet_reference_no').rules('remove', 'required');
      ...
      function interDetailsRequired() {
        ...
        $('#inter_marksheet_reference_no').validate();
        $('#inter_marksheet_reference_no').rules('add', {
          required: true
        });
        <?php if (empty($id)) { ?>
      ...
      function interDetailsNotRequired() {
        ...
        $('#inter_marksheet_reference_no').rules('remove', 'required');
      ...
      function ugDetailsRequired() {
        ...
        $('#ug_marksheet_reference_no').validate();
        $('#ug_marksheet_reference_no').rules('add', {
          required: true
        });
        <?php if (empty($id)) { ?>
      ...
      function ugDetailsNotRequired() {
        ...
        $('#ug_marksheet_reference_no').rules('remove', 'required');
      ...
      function pgDetailsRequired() {
        ...
        $('#pg_marksheet_reference_no').validate();
        $('#pg_marksheet_reference_no').rules('add', {
          required: true
        });
        <?php if (empty($id)) { ?>
      ...
      function pgDetailsNotRequired() {
        ...
        $('#pg_marksheet_reference_no').rules('remove', 'required');
      ...
      function otherDetailsRequired() {
        ...
        $('#other_marksheet_reference_no').validate();
        $('#other_marksheet_reference_no').rules('add', {
          required: true
        });
        <?php if (empty($id)) { ?>
      ...
      function otherDetailsNotRequired() {
        ...
        $('#other_marksheet_reference_no').rules('remove', 'required');
        ...
        $.ajax({
          ...
          success: function (data) {
            if (data.status) {
              ...
              if (data.eligibility == "Last Qulifications" || course_category === "pg_diploma") {
