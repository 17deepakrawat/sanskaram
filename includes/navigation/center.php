    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          ...
          ?>
            <li class="<?php print $breadcrumbs[1]=='accounts' ? 'open active' : '' ?>">
              ...
              <ul class="sub-menu">
                ...
                <?php }  else{ ?>
                  <li class="<?php print $breadcrumbs[2] == "student-ledgers" ? 'active' : '' ?>">
                    <a href="/accounts/student-ledgers">Student Ledgers</a>
                    <span class="icon-thumbnail"><i class="pg-icon">SCL</i></span>
              	</li>
               <?php  } ?>
              </ul>
          ...
          <li class="">
            <a href="/lms-settings/results">Results List</a>
            <span class="icon-thumbnail"><i class="pg-icon">RL</i></span>
          </li>
