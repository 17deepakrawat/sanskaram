        ...
        <div class=" container-fluid sm-p-l-0 sm-p-r-0">
          <div class="inner">
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <button class="custom_add_button  p-2 " data-toggle="tooltip" data-original-title="Add videos" onclick="add('videos','lg')">Add <i class="uil uil-plus-circle"></i></button>
            ...
            <div class="pull-right">
              <div class="row">
                <div class="col-xs-7" style="margin-right: 10px;">
                  <input type="text" id="video_lectures-search-table" class="form-control pull-right p-2 fw-bold custom_search_section" placeholder="Search">
                </div>
          ...
          'columns': [{
            ...
            },
            {
              ...
              "render": function(data, type, row) {
                ...
                <i class="uil uil-edit icon-xs cursor-pointer custom_edit_button" onclick="edit(&#39;videos&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                        <i class="uil uil-trash icon-xs cursor-pointer custom_edit_button" onclick="changeStatus(' + "'video_lectures'" + ', ' + data + ',' + "'status'" + ',2)"></i>\
                      </div>'
              }
            },
          ],
