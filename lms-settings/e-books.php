        ...
        <div class=" container-fluid sm-p-l-0 sm-p-r-0">
          <div class="inner">
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <button class="custom_add_button" data-toggle="tooltip" data-original-title="Add E-books" onclick="add('e-books','lg')"> Add <i class="uil uil-plus-circle ml-2"></i></button>
            ...
            },
            {
              ...
              "render": function(data, type, row) {
                ...
                return '<div class="form-check form-check-inline switch switch-lg success">' +
                  '<input onclick="changeStatus(\'e_books\', ' + row.ID + ')" type="checkbox" ' + checked + ' id="status-switch-' + row.ID + '">' +
