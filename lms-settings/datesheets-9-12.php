          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group form-group-default required">
                ...
                <select class="full-width" style="border: transparent;" id="course" data-init-plugin ="select2" data-placeholder = "Choose Courses" onchange="getSemester(this.value)">
                  <option value="">Choose courses(Sub-Course)</option>
                  <?php
                  $condition = "";
            ...
            <div class="col-md-6">
              <div class="form-group form-group-default required">
                ...
                <select class="full-width" style="border: transparent;" id="semester" data-init-plugin ="select2" data-placeholder = "Choose Duration" onchange="getTable()">
