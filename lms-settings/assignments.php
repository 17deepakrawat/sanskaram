    ...
    <div class="content ">
        ...
        <div class=" container-fluid   sm-p-l-0 sm-p-r-0">
          <div class="inner">
            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              ?>
              <button class="custom_add_button text-white" aria-label="Add Assignments" data-toggle="tooltip" data-placement="top" title="Add Assignments" onclick="add('assignments','lg')">Create Assignments <i class="uil uil-file-alt ml-2"></i></button>
      ...
      <div class="container-fluid">
        <div class="card card-transparent">
          ...
          <div class="card-body">
            <div class="">
              <table class="table table-hover nowrap table-responsive" id="admin_table">
                <thead>
                  <tr>
          ...
          'columns': [{
            ...
            },
            {
              ...
              render: function(data, type, row) {
                ...
                if (row.File_Type && row.File_Type.toLowerCase() === 'pdf') {
                  file = '<a href="' + path + data + '" class="badge p-2  badge-success btn-sm" download>Download Assignment</a>';
                } else {
                  file = '<a href="' + path + data + '"  class="badge p-2  badge-success btn-sm" download>Download Assignment</a>';
                }
                return file;
            ...
            },
            {
              ...
              "render": function(data, type, row) {
                ...
                <i class="uil uil-edit icon-xs cursor-pointer custom_edit_button" title="Edit" onclick="edit(&#39;assignments&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="uil uil-trash icon-xs cursor-pointer custom_edit_button" title="Delete" onclick="destroy(&#39;assignments&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
              }
            },
          ],
