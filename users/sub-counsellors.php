...
<style>
  ...
  .btn-link:hover:not(.active) {
    ...
    background: rgb(43 48 59) !important;
    border: 0 !important;
          ...
          <div class="inner">
            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <div class="text-end">
                ...
                <button class="btn btn-link custom_add_button" aria-label="" title="" data-toggle="tooltip" data-original-title="Add" onclick="add('sub-counsellors','lg')"> <i class="uil uil-plus-circle"></i></button>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
          </div>
      ...
      <label for="status-switch-' + row.ID + '">' + active + '</label>\
            ...
            },
            {
              ...
              "render": function(data, type, row) {
                ...
                <i class="uil uil-edit icon-xs cursor-pointer custom_edit_button" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;sub-counsellors&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="uil uil-trash icon-xs cursor-pointer custom_edit_button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;sub-counsellors&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
              }
            },
          ],
