        ...
        <div class=" container-fluid   sm-p-l-0 sm-p-r-0">
          <div class="inner">
            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              ?>
              <div class="text-end">
                <span class="text-muted bold cursor-pointer custom_add_button text-white" onclick="add('university-heads','lg')"> Add  <i class="uil uil-plus-circle  cursor-pointer"></i></sapn>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
        ...
        var settings = {
          ...
          'columns': [{
            ...
            },
            {
              data: "Status",
              "render": function(data, type, row) {
                var active = data == 1 ? '<span class="badge badge-success">Active</span>' : '<span class="badge badge-danger">Inactive</span>';
      ...
      <label for="status-switch-' + row.ID + '">' + active + '</label>\
            ...
            },
            {
              ...
              "render": function(data, type, row) {
                ...
                <i class="uil uil-plus-circle icon-xs cursor-pointer custom_edit_button" data-toggle="tooltip" data-placement="top" title="Allot University" onclick="allot(&#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="uil uil-edit icon-xs cursor-pointer custom_edit_button" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;university-heads&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="uil uil-trash icon-xs cursor-pointer custom_edit_button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;university-heads&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
              }
            },
          ],
