        ...
        <div class=" container-fluid   sm-p-l-0 sm-p-r-0">
          <div class="inner">
            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              ?>
              <div class="text-end">
                <span class="text-muted bold cursor-pointer custom_add_button text-white" onclick="add('operations','lg')"> Add <i class="uil uil-plus-circle  cursor-pointer"></i></sapn>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
      ...
      <label for="status-switch-' + row.ID + '">' + active + '</label>\
            ...
            },
            {
              ...
              "render": function(data, type, row) {
                ...
                <i class="uil uil-edit icon-xs cursor-pointer custom_edit_button" title="Edit" onclick="edit(&#39;operations&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="uil uil-trash icon-xs cursor-pointer custom_edit_button" title="Delete" onclick="destroy(&#39;operations&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
              }
            },
          ],
