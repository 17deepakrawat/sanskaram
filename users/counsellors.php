          ...
          <div class="inner">
            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <div class="text-end">
                ...
                <button class="btn btn-link custom_add_button " aria-label="" title="" data-toggle="tooltip" data-original-title="Add" onclick="add('counsellors','lg')"> <i class="uil uil-plus-circle"></i></button>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
          </div>
        ...
        var settings = {
          ...
          'columns': [{
            ...
            },
            {
              ...
              <i class="uil uil-edit icon-xs cursor-pointer custom_edit_button" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;counsellors&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
              <i class="uil uil-trash icon-xs cursor-pointer custom_edit_button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;counsellors&#39;, &#39;' + data + '&#39)"></i>\
            </div>'
              }
            },
          ],
