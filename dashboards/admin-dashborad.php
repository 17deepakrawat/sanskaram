                        ...
                        <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
                            ...
                            for ($i = 1; $i <= count($breadcrumbs); $i++) {
                                if (count($breadcrumbs) == $i) : $active = "active";
                                    ...
                                    echo '<li class="breadcrumb-item ' . $active . '">' . ucwords(strtolower($crumb[0])) . '</li>';
                                endif;
                            }
                            ?>
                        </ol>
                ...
                <div class="row">
                    <div class="col-sm-4 col-xl-3 col-lg-4">
                        ...
                        <div class="card custom-card custom_round ">
                            <a href="/users/centers" class="link_dash_card cursor-pointer">
                                <div class="card-body dash1 custom_round dash_card_shadow">

                                    <div class="d-flex">
                                        <p class="mb-1 tx-inverse h4 font-weight-bold custom_text_font">Total centers</p>
                                        <div class="ml-auto">
                                    ...
                                    <div>
                                        ...
                                        ?>
                                        <h3 class="dash-25 dashboard_gap_panel d-flex align-items-end custom_text_font"><span><i class="uil uil-graduation-hat h1 dashboards_icon_bg"></i></span><span class="fw_custom_text"><?= $totalRecords ?></span></h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-sm-4 col-xl-3 col-lg-4">
                        <div class="card custom-card custom_round ">
                            <a href="/admissions/applications" class="link_dash_card cursor-pointer">
                                <div class="card-body dash1  custom_round dash_card_shadow">
                                    <div class="d-flex">
                                        <p class="mb-1 tx-inverse h4 font-weight-bold custom_text_font">Total students</p>
                                        <div class="ml-auto">
                                            <i class="fas fa-chart-line fs-20 text-primary "></i>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        $totalRecords = $records['allcount'];
                                        ?>
                                        <h3 class="dash-25 dashboard_gap_panel d-flex align-items-end custom_text_font"><span><i class="uil uil-users-alt h1 dashboards_icon_bg"></i></span><span class="fw_custom_text"><?= $totalRecords ?></span></h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-sm-4 col-xl-3 col-lg-4">
                        <div class="card custom-card custom_round ">
                            <a href="/academics/specializations" class="link_dash_card cursor-pointer">
                                <div class="card-body dash1 custom_round dash_card_shadow">
                                    <div class="d-flex">
                                        <p class="mb-1 tx-inverse h4 font-weight-bold custom_text_font">Total programs</p>
                                        <div class="ml-auto">
                                            <i class="fas fa-chart-line fs-20 text-primary "></i>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        $totalRecords = $records['allcount'];
                                        ?>
                                        <h3 class="dash-25 dashboard_gap_panel d-flex align-items-end custom_text_font"><span><i class="uil uil-book-open h1 dashboards_icon_bg"></i></span><span class="fw_custom_text"><?= $totalRecords ?></span></h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-sm-4 col-xl-3 col-lg-4">
                        <div class="card custom-card custom_round">
                            <div class="card-body dash1 custom_round dash_card_shadow">
                                <div class="d-flex">
                                    <p class="mb-1 tx-inverse h4 font-weight-bold custom_text_font">Total Revenue</p>
                                    <div class="ml-auto">
                                        <i class="fas fa-chart-line fs-20 text-primary"></i>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    ?>
                                    <h3 class="dash-25 dashboard_gap_panel d-flex align-items-end"><span class="d-flex align-items-end"><iconify-icon icon="uil:rupee-sign" class="h1 dashboards_icon_bg "></iconify-icon></span><span class="fw_custom_text"><?= $totalRecords ?></span></h3>
                                </div>
                            </div>
                        </div>
                    </div>
